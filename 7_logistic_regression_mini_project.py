...
model = pickle.load(open("logistic_model_basic_project.pkl","rb"))

st.title("Custom Churn Prediction Using Logistic Regression for Classification")
...
tenure = st.text_input("Enter your tenure (In number)")
PhoneService = st.selectbox("Do you have phone services?", options=["Yes","No"])
MultipleLines = st.selectbox("Do you have multiple lines services?", options=['Yes','No'])
